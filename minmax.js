function gerar() {
    if (document.querySelector("#inumMin-valorMinimo").value == '' || document.querySelector("#inumMax-valorMinimo").value == '' || document.querySelector("#inumMin-valorMaximo").value == '' || document.querySelector("#inumMax-valorMaximo").value == '') /*verifica se os campos estao vazios*/ {
        ...
        if (numMax_Minimo > numMin_Minimo && numMin_Maximo >= numMax_Minimo && numMax_Maximo > numMin_Maximo)  {
            ...
            resultado.innerText = "ERRO! Preencha os campos de forma lógica."
        }
    }
